...
struct avb_interface_dynamic_desc {
	...
	u8 async_get_as_path_unsolicited_notification_pending:1; /**< Flag used to state if an unsolicited notification is registered to be sent (on next timer expiration) for this AVB_INTERFACE. */
